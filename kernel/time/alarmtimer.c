...
static int alarm_timer_create(struct k_itimer *new_timer)
{
	...
	printk("Enter alarm_timer_create\n");
	if (!alarmtimer_get_rtcdev())
		return -ENOTSUPP;
	...
	printk("Exit alarm_timer_create\n");
	return 0;
}
